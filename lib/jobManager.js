...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, nTime, nonce, ipAddress, port, workerName, eqsol){
        ...
        if (!job.registerSubmit(extraNonce1, nTime, nonce)) {
        ...
        var coinbaseBuffer = job.serializeCoinbase(extraNonce1Buffer, nonceBuffer);
        ...
        var headerBuffer = job.serializeHeader(merkleRoot, nTime, nonce, eqsol);
